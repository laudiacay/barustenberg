...
pub trait Bn254Fq2Params: Field2Params<Fq> {
    ...
    const twist_m_by_q_x_0: Fq = Fq::from_parts(
        0xb5773b104563ab30,
        0x347f91c8a9aa6454,
        0x7a007127242e0991,
        0x1956bcd8118214ec,
    );
    const twist_m_by_q_x_1: Fq = Fq::from_parts(
        0x6e849f1ea0aa4757,
        0xaa1c7b6d89f89141,
        0xb6e713cdfae0ca3a,
        0x26694fbb4e82ebc3,
    );
    const twist_m_by_q_y_0: Fq = Fq::from_parts(
        0xe4bbdd0c2936b629,
        0xbb30f162e133bacb,
        0x31a9d1b6f9645366,
        0x253570bea500f8dd,
    );
    const twist_m_by_q_y_1: Fq = Fq::from_parts(
        0xa1d77ce45ffe77c7,
        0x07affd117826d1db,
        0x6d16bd27bb7edc6b,
        0x2c87200285defecc,
