...
impl FieldParamsGeneral for Bn254FrParamsImpl {}

impl FieldParams for Bn254FrParamsImpl {
    const modulus_0: u64 = 0x43E1F593F0000001;

    const modulus_1: u64 = 0x2833E84879B97091;
