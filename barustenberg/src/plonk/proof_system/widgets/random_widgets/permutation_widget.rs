...
use crate::transcript::{Transcript, HasherType};
use std::marker::PhantomData;
use std::sync::Arc;

pub struct VerifierPermutationWidget<Field, Group, const NUM_ROOTS_CUT_OUT_OF_VANISHING_POLYNOMIAL: usize>
where
    Field: ark_ff::Field,
{
...
pub struct ProverPermutationWidget<Fr: Field, Hash:HasherType, const PROGRAM_WIDTH: usize, const IDPOLYS: bool, const NUM_ROOTS_CUT_OUT_OF_VANISHING_POLYNOMIAL: usize> {
    prover_random_widget: ProverRandomWidget,
}

impl<Fr: Field, Hash:HasherType, const PROGRAM_WIDTH: usize, const IDPOLYS: bool, const NUM_ROOTS_CUT_OUT_OF_VANISHING_POLYNOMIAL: usize> ProverPermutationWidget<Fr: Field, Hash:HasherType, PROGRAM_WIDTH, IDPOLYS, NUM_ROOTS_CUT_OUT_OF_VANISHING_POLYNOMIAL> {
